...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESpeechLanguage(ESpeechLanguage_StaticEnum, TEXT("/Script/FlytekVoiceSDK"), TEXT("ESpeechLanguage"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(USpeekRecognizerFunctionLibrary, 1377939410);
...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_FlytekVoiceSDK_ESpeechLanguage()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechLanguage::EL_Chinese")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechLanguage::EL_English")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeechLanguage::EL_MAX")), 2));
	...
	uint32 Get_Z_Construct_UEnum_FlytekVoiceSDK_ESpeechLanguage_CRC() { return 3884075756U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UFunction* Z_Construct_UFunction_USpeekRecognizerFunctionLibrary_InitializeSpeechRecognizer()
	{
		...
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_InLanguage = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("InLanguage"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(InLanguage, SpeekRecognizerFunctionLibrary_eventInitializeSpeechRecognizer_Parms), 0x0010000000000080, Z_Construct_UEnum_FlytekVoiceSDK_ESpeechLanguage());
			UProperty* NewProp_InLanguage_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_InLanguage, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_USpeekRecognizerFunctionLibrary()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USpeekRecognizerFunctionLibrary_InitializeSpeechRecognizer(), "InitializeSpeechRecognizer"); // 1665063378
